...
/**
 * get hex directly from colour
 * @param hue hue
 * @param shad shade
 */
export function getCH( hue: hues, shad: shades ) {
    return getC( hue, shad ).hex;
}
enum colourE {
    pinks = hues.pinks,
    purples = hues.purples,
    violets = hues.violets,
    blues = hues.blues,
    aquas = hues.aquas,
    greens = hues.greens,
    limes = hues.limes,
    yellows = hues.yellows,
    browns = hues.browns,
    oranges = hues.oranges,
    apricots = hues.apricots,
    reds = hues.reds
}
export function getColours( hue: colourE, shad: shades ) { 
    return getC( hue, shad );
};
enum neutE {
    cools = hues.cools,
    warms = hues.warms,
    neutrals = hues.neutrals
}
export function getNeutrals( hue: neutE, shad: shades ) {
    return getC( hue, shad );
};
